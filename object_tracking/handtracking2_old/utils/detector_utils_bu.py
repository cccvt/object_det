...
import sys
image_classifier_path = r'/home/testuser/PycharmProjects/obj_detector/test'
...
classifier_model.load(os.path.join(image_classifier_path, r'image_classifier/models/handgesture-0.0005-20180319-1358-5conv-basic.model'))
...
def draw_box_on_image(num_hands_detect, score_thresh, scores, boxes, im_width, im_height, image_np):
    for i in range(num_hands_detect):
        if (scores[i] > score_thresh):
            ...
            # detect hand pose
            score, guess = detect_hand_pose(image_np, (left, right, top, bottom))
            if guess is None:
                score = 0
                guess = '???'
