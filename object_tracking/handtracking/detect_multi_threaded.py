...
def worker_pose(input_q, output_q, cap_params, frame_processed):
    import tensorflow as tf
    print(">> loading frozen model for worker")
    detection_graph, sess = detector_utils.load_inference_graph(r'/home/testuser/tf_tut/tf_image_classifier/tf_files/retrained_graph.pb')
...
if __name__ == '__main__':
    ...
    pool_hand = Pool(args.num_workers, worker_hand,
                     (input_q, output_q, cap_params, frame_processed))

    # pool_pose = Pool(args.num_workers, worker_pose(),
    #                  (input_q, output_q, cap_params, frame_processed))
